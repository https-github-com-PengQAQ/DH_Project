...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(System.Collections.Generic.List<int> p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Type __Gen_Delegate_Imp19(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Object __Gen_Delegate_Imp25(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp26(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Object __Gen_Delegate_Imp27(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public AssetInfo __Gen_Delegate_Imp28(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                AssetInfo __gen_ret = (AssetInfo)translator.GetObject(L, errFunc + 1, typeof(AssetInfo));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public UnityEngine.Object __Gen_Delegate_Imp29(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UIManager __Gen_Delegate_Imp30()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Transform __Gen_Delegate_Imp31(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp44(object p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp45(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public Scene.SceneMgr __Gen_Delegate_Imp46()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                Scene.SceneMgr __gen_ret = (Scene.SceneMgr)translator.GetObject(L, errFunc + 1, typeof(Scene.SceneMgr));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public RoomIdentity __Gen_Delegate_Imp47(object p0, object p1, UnityEngine.Vector3 p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                RoomIdentity __gen_ret = (RoomIdentity)translator.GetObject(L, errFunc + 1, typeof(RoomIdentity));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public void __Gen_Delegate_Imp48(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(IdleState.enemyDeadOne))
			{
			    return new IdleState.enemyDeadOne(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(AtkCtrl.hit))
			{
			    return new AtkCtrl.hit(__Gen_Delegate_Imp11);
			}
		    ...
		    if (type == typeof(Map.RoomGenerator.ChangeMap))
			{
			    return new Map.RoomGenerator.ChangeMap(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(Map.RoomGenerator.ChangeCameraPos))
			{
			    return new Map.RoomGenerator.ChangeCameraPos(__Gen_Delegate_Imp15);
			}
