...
namespace XLua.CSObjectWrap
{
    ...
    public class StateTypeWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(StateType), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(StateType), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(StateType), L, null, 8, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Idle", StateType.Idle);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Patrol", StateType.Patrol);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Chase", StateType.Chase);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "React", StateType.React);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Attack", StateType.Attack);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Hit", StateType.Hit);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Death", StateType.Death);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(StateType), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushStateType(L, (StateType)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushStateType(L, StateType.Idle);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Patrol"))
                {
                    translator.PushStateType(L, StateType.Patrol);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Chase"))
                {
                    translator.PushStateType(L, StateType.Chase);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "React"))
                {
                    translator.PushStateType(L, StateType.React);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Attack"))
                {
                    translator.PushStateType(L, StateType.Attack);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Hit"))
                {
                    translator.PushStateType(L, StateType.Hit);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Death"))
                {
                    translator.PushStateType(L, StateType.Death);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for StateType!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for StateType! Expect number or string, got + " + lua_type);
            }
